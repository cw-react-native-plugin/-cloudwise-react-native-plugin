...
Pod::Spec.new do |s|
  ...
  s.vendored_libraries = "ios/lib/libCloudwise.a"
  ...
  s.license      = { :type => "Commercial", :text =>
                     "Terms of Service
					  ...
					  1.0 Introduction.
					  These Terms of Service constitute the agreement between You and Cloudwise, a division of Cloudwise LLC, a Delaware company (together hereinafter referred to as 'Cloudwise'). BY USING THE SERVICE, YOU ACKNOWLEDGE THAT YOU HAVE REVIEWED AND ACCEPT THIS AGREEMENT AND ARE AUTHORIZED TO ACT ON BEHALF OF, AND BIND YOUR ENTITY ('CLIENT') TO THIS AGREEMENT.
					  Cloudwise reserves the right to change or modify these Terms of Service at our sole discretion at any time by posting updated Terms of Service on the Cloudwise website. Any change or modification to the Terms of Service will be effective immediately upon posting. In all cases, your continued use of the Services after publication of such modifications constitutes binding acceptance of the modified Terms of Service.

					  2.0 Scope of the Cloudwise Service; Restrictions.
					  The 'Service' shall be defined as the hosted services, electronic reports, analyses, documentation or Auxiliary Programs provided by Cloudwise under this Agreement which are necessary to deploy the service. Client shall have the right to use the Service ordered and made available to Client by Cloudwise hereunder for their internal use. 'Auxiliary Program'. means any software, agent or equipment that Cloudwise makes available to Client as part of the Service for purposes of facilitating access to, operation of, and/or use with, the Service.
					  Client shall not: (a) reverse engineer, decompile, decode, decrypt, disassemble, or in any way derive source code from the Service and/or Auxiliary Programs; (b) modify, translate, adapt, alter, or create derivative works from the Service and/or Auxiliary Programs; (c) copy, distribute, publicly display, transmit, make available in any 'public' area or accessible on the World Wide Web; (d) sublicense, sell, rent, or lease the Service and/or Auxiliary Programs; or (e) use the Service and/or Auxiliary Programs for the purposes of competing with Cloudwise, including without limitation competitive intelligence or analysis.

					  3.0 Pricing & Payment Terms.
					  Prices for the Service are set forth on the Cloudwise website. Payment may be made either immediately by credit card, or invoiced as provided herein. If payment is made by invoice, Cloudwise will invoice the full invoice and Client shall remit payment within thirty (30) days of the invoice date. Overdue invoices shall bear interest at 1.5% per month or such lower rate as shall be the then highest rate permitted by law. Client shall pay all applicable taxes due under this Agreement, except taxes based on Cloudwise's net income unless Client provides Cloudwise with a properly completed exemption certificate. All prices are exclusive of all taxes, duties, VAT, withholdings and other governmental assessments. Cloudwise reserves the right to suspend Services and delete all Client date held by Cloudwise, if Client fails to pay as provided herein.

					  4.0 Intellectual Property.
					  Client acknowledges and agrees that all ownership and proprietary rights to the Service, Auxiliary Programs and the contents thereof and all related intellectual property are and shall remain the property exclusively of Cloudwise. Cloudwise retains full rights of ownership and use in: (a) any programs, products, materials or methodologies or materials of Cloudwise created and/or developed by Cloudwise prior to or independently of the Services contemplated herein ('Pre-existing Works'); and (b) all materials, methodologies, processes, techniques, ideas, concepts, trade secrets, and know-how, which may be created or developed in connection with the Services and are modifications and/or derivatives of Cloudwise's Pre-existing Works.
					  ...
					  Client agrees that the Service: i) is Confidential Information; and ii) constitutes valuable assets and confidential trade secrets of Cloudwise. Client therefore agrees to keep in confidence and protect the Service, including but not limited to screenshots, ideas, concepts, designs, specifications, computer programs and strategies from disclosure to third parties and restrict its use as provided in this Agreement

					  6.0 Term and Termination.
					  The term ('Term') of the Service shall be specified as specified on the Cloudwise website.

					  7.0 Warranty.
					  Cloudwise warrants that the Service will function in substantial compliance with their specifications published by Cloudwise (available at help.cloudwise.com). Client acknowledges that changes by Client to its monitoring profile or corrupted, incomplete and/or interrupted data received by Cloudwise from Client's site(s), may have a material impact on the accuracy, reliability and/or timeliness of Service results, and Cloudwise shall not be responsible for any such factors beyond its reasonable control. THE ABOVE WARRANTIES ARE DYNATRACE'S ONLY WARRANTIES AND NO OTHER WARRANTY, EXPRESS OR IMPLIED, INCLUDING THE IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE, WILL APPLY.
					  ...
					  Premium support for the Services is available on a subscription basis. Such support is provided AS IS, with no warranty, express or implied. Expert services are available on demand, on an hourly bases, at the Cloudwise then-current rates.
					  ...
					  14.3 Governing Law.
					  This Agreement will be governed by and construed in accordance with the laws of the State of Michigan without regard to its conflicts of law principles. If the entity selling the Service is a wholly owned affiliate of Cloudwise LLC, this Agreement will be governed by the laws of the country in which such affiliate is situated.
					  ...
					  These Terms of Service constitute the complete and exclusive agreement between the parties with respect to the subject matter hereof, superseding any prior agreements and communications (both written and oral). The terms and conditions contained in any purchase order shall be of no force or effect, even if the order is accepted by Cloudwise. This Agreement may only be modified, or any rights under it waived, by a written document executed by both parties.
  ...
  # --- Author --------------------------------------------------------- #
  #
  s.author             = { "Cloudwise" => "support.mobile@cloudwise.com" }
  s.social_media_url   = "https://twitter.com/cloudwise"
